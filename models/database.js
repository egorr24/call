...
// Модель пользователя
let User, Chat, ChatParticipant, Message, File;
...
async function initDatabase() {
    if (!sequelize) {
        console.log('⚠️  База данных не настроена, используем режим без БД');
        return false;
    }
    ...
    try {
        ...
        console.log('⚠️  Переключаемся на режим без базы данных');
        return false;
    }
}
